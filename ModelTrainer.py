...
version = "EX006B" #Deterministic PPO Unlettered: 5x5, B: 50x50, C:normalized budget DQN A: 512,512,265 network B: 512,512,265,256 network, increased exploration to .9
...
class SimpleFeatureExtractor(BaseFeaturesExtractor):    #IM Update
    def __init__(self, observation_space, num_edges=60, num_nodes=27, embedding_dim=128,
...
policy_kwargs = dict(
    ...
    features_extractor_kwargs={
        'num_edges': 60, #168, #  270, #60, #
        'num_nodes': 27, #66, #  102, #27, #
        'embedding_dim': 128,
...
if __name__ == "__main__":
    ...
    # Train the agent
    model.learn(total_timesteps=timesteps, callback=[checkpoint_callback, eval_callback], #CurriculumCallback()],
                progress_bar = True)
